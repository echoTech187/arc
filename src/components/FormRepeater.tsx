...
type defaultValueProps = { value: { id: string, user_id: string, hours_worked: string, calculated_remuneration: string } };
const FormRepeater = ({ defaultValue, isShared, hoursWorked }: any) => {
    const [fields, setFields] = useState<defaultValueProps[]>([
        { value: { id: '', user_id: '', hours_worked: '0', calculated_remuneration: '0' } }
    ]);
        ...
        function getJobAssignment() {
            ...
            if (defaultValue.length > 0) {
                for (let i = 0; i < defaultValue.length; i++) {
                    ...
                    const calculated_remuneration = defaultValue[i]['calculated_remuneration'];
                    job_assignment.push({
                        value: {
                            id,
                            user_id,
    ...
    const addField = () => {
        setFields([...fields, { value: { id: '', user_id: '', hours_worked: '0', calculated_remuneration: '0' } }]);
    };
